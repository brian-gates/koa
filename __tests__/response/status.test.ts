...
describe("res.status=", () => {
  describe("when a status code", () => {
    describe("and valid", () => {
      ...
      it("should not throw", () => {
        (createContext().response as any).status = 403;
      });
    });
    ...
    describe("and invalid", () => {
      it("should throw", () => {
        assert.throws(() => {
          (createContext().response as any).status = 99;
    ...
    describe("and custom status", () => {
      beforeEach(() => {
        (statuses as any)["700"] = "custom status";
      });
      ...
      it("should not throw", () => {
        (createContext().response as any).status = 700;
      });
    });
  ...
  describe("when a status string", () => {
    it("should throw", () => {
      assert.throws(() => {
        (createContext().response as any).status = "forbidden";
