...
const response = {
   ...
   *
   * @param {String} field
   * @return {string | string[] | number | undefined}
   * @api public
   */
   ...
   *
   * @param {String|{ [k: string]: string | string[] | number }} field
   * @param {string | string[] | number} [val]
   * @api public
   */
...
if (util.inspect.custom) {
  response[util.inspect.custom] = response.inspect;
}
